// Version mobile — Variante B adaptée
// Reprend le langage visuel de SiteB en mobile-first
          ...
          <div style={{ marginTop: 16, background: t.sable, overflow: 'hidden' }}>
            ...
            {[
              ...
              <div key={gi} style={{ padding: '14px 18px', borderBottom: gi < arr.length - 1 ? `1px solid ${t.bord}` : 'none' }}>
                ...
                {g.arrets.map((a, ai) => (
                  <div key={ai} style={{ marginBottom: ai < g.arrets.length - 1 ? 10 : 0 }}>
...
Object.assign(window, { SiteMobile });
